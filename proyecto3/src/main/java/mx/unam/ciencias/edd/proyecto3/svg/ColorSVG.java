...
public enum ColorSVG {
	NINGUNO("none"), ALICEBLUE("#f0f8ff"), ANTIQUEWHITE("#faebd7"), AQUA("#00ffff"), AQUAMARINE("#7fffd4"),
	ASTRONAUTBLUE("#003f5c"), AZURE("#f0ffff"), BEIGE("#f5f5dc"), BISQUE("#ffe4c4"), BLACK("#000000"),
	BLANCHEDALMOND("#ffebcd"), BLUE("#0000ff"), BLUEVIOLET("#8a2be2"), BONDIBLUE("#058CB6"), BROWN("#a52a2a"),
	BURLYWOOD("#deb887"), BUTTERFLYBUSH("#665191"), CADETBLUE("#5f9ea0"), CARNATION("#f95d6a"), CHARTREUSE("#7fff00"),
	CHAMBRAY("#2f4b7c"), CHOCOLATE("#d2691e"), CORAL("#ff7c43"), CORNFLOWERBLUE("#6495ed"), CORNSILK("#fff8dc"),
	CRANBERRY("#d45087"), CRIMSON("#dc143c"), CYAN("#00ffff"), DARKBLUE("#00008b"), DARKCYAN("#008b8b"),
	...
	GOLDENROD("#daa520"), GOLD("#ffd700"), GRAY("#808080"), GREEN("#008000"), GREENYELLOW("#adff2f"), GREY("#808080"),
	HONEYDEW("#f0fff0"), HOTPINK("#ff69b4"), INDIANRED("#cd5c5c"), INDIGO("#4b0082"), IVORY("#fffff0"),
	KHAKI("#f0e68c"), LAVENDERBLUSH("#fff0f5"), LAVENDER("#e6e6fa"), LAWNGREEN("#7cfc00"), LEMONCHIFFON("#fffacd"),
	...
	TAN("#d2b48c"), TAPESTRY("#a05195"), TEAL("#008080"), THISTLE("#d8bfd8"), TOMATO("#ff6347"), TURQUOISE("#40e0d0"),
	VIOLET("#ee82ee"), WEBORANGE("#ffa600"), WHEAT("#f5deb3"), WHITE("#ffffff"), WHITESMOKE("#f5f5f5"),
	...
	/**
	 * Obtiene el valor hexadecimal del color.
	 * 
	 * @return
	 */
